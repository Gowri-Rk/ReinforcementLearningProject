...
from Connect4Env.connect4_env import Connect4Env, Winner, Player
from helpers import tf_util
from helpers.data_helper import get_game_data_filenames, write_game_data_to_file
from helpers.model_helpler import load_best_model_weight, save_as_best_model, \
...
class SelfPlayWorker:
    def __init__(self, config: Config, env=None, model=None):
        ...
        :param agent.model_connect4.Connect4Model|None model:
        """
        self.config = config
        self.model = model
