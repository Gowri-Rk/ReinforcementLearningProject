...
def _data_dir():
    return os.path.join(_project_dir(), "data_generated")
...
class ResourceConfig:
    def __init__(self):
        ...
        self.selfPlay_log_path = os.path.join(self.log_dir, "selfplay.log")
        self.opt_log_path = os.path.join(self.log_dir, "opt.log")
        self.eval_log_path = os.path.join(self.log_dir, "eval.log")
        self.game_log_path = os.path.join(self.log_dir, "game.log")
