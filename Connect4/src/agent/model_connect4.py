...
class Connect4Model:
    ...
    def build(self):
        ...
        x = Dense(mc.value_fc_size, kernel_regularizer=l2(mc.l2_reg), activation=activation, name="value_dense")(x)
    ...
    def _build_residual_block(self, x, index):
        ...
        x = Conv2D(filters=mc.cnn_filter_num, kernel_size=mc.cnn_filter_size, padding="same",
                   data_format="channels_first", kernel_regularizer=l2(mc.l2_reg),
